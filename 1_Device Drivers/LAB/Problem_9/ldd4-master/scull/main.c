...
int scull_read_procmem(struct seq_file *s, void *v)
{
	...
	for (i = 0; i < scull_nr_devs && s->count <= limit; i++) {
		...
		for(k=j; k<scull_quantum;k++)
		{
		   if(*((char *)(d->data->data[0]+j))>*((char *)(d->data->data[0]+k)))
		   {
		   temp=*((char *)(d->data->data[0]+j));
		   *((char *)(d->data->data[0]+j))=*((char *)(d->data->data[0]+k));
		   *((char *)(d->data->data[0]+k))=temp;
		   }
...
{
	proc_create_data("sortfirstquantum", 0 /* default mode */,
...
static void scull_remove_proc(void)
{
	...
	remove_proc_entry("sortfirstquantum", NULL /* parent dir */);
